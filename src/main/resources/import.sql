...
INSERT INTO users (username, password, role_id, lastname)
VALUES ('superadmin', '$2a$10$XXXX', 1,'Toulioudas');

INSERT INTO users (username, password, role_id,lastname)
VALUES ('admin', '$2a$10$YYYY', 2,'singeAmdin');

INSERT INTO users (username, password, role_id,lastname)
VALUES ('user', '$2a$10$ZZZZ', 3,'singleUser');
